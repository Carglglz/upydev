...
SERVS = dict(
    help="show GATT services and characteristics",
    subcmd={},
    options={
        "-t": dict(
            help="show services and characteristics in " "tree format",
            required=False,
            default=False,
            action="store_true",
        )
...
class ShellBleCmds(ShellCmds):
    def __init__(self, *args, **kargs):
        ...
        self.dsyncio = ShDsyncIO(
            self.dev, self.dev_name, self.fileio, self.fastfileio, shell=self
        )
