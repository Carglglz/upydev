...
TLSv1/SSLv3 @ ECDHE-RSA-AES256-GCM-SHA384 - 256 bits Encryption
...
* **RSA-2048 bits private key and self-signed certificate:** The key and certificate is generated by the host and then uploaded to the device. This will allow Server-client authentication
